...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,10), (R,10), (U,20), (D,30)]) -- reset the GapSpec
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,0), (R,0), (U,35), (D,0)] $ spacingRaw True (Border 0 0 0 0) True (Border 0 0 0 0) True $ smartBorders $ myLayout,
